        ...
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/addAppInfo" method="post" enctype="multipart/form-data">
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="softwareName" class="form-control col-md-7 col-xs-12" 
               data-validate-length-range="20" data-validate-words="1" name="softwareName" value="${addInfoBack.softwareName}"  required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="APKName" class="form-control col-md-7 col-xs-12" 
              	data-validate-length-range="20" data-validate-words="1" name="APKName" value="${addInfoBack.APKName}"   required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="supportROM" class="form-control col-md-7 col-xs-12" name="supportROM" 
              	data-validate-length-range="20" data-validate-words="1" value="${addInfoBack.supportROM}"    required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              data-validate-length-range="20" data-validate-words="1" name="interfaceLanguage" value="${addInfoBack.interfaceLanguage}"  required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="softwareSize" name="softwareSize"  value="${addInfoBack.softwareSize}"  required="required" onkeyup="value=value.replace(/[^\d]/g,'')"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="downloads" name="downloads" value="${addInfoBack.downloads}"   required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="appInfo" name="appInfo" value="${addInfoBack.appInfo}"    required="required"
